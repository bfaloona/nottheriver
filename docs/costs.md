...
| LLM prompt | Measured with the enrich cap's 40 candidates (24 online, 16 local) at the title and snippet caps, 200-character URLs and a 120-character product name: normalize prompt 1,543 characters, enrich prompt 35,799 characters. The local cap is now 20, and 4 more capped candidates add 3,252 characters (measured), so about 39,051. URLs are not capped, so a longer URL raises this figure | about (1,543 + 39,051) × 2 × $0.09/M ≈ $0.0073 at the cheapest endpoint's price, taking the loose bound of one token per character; about $0.061 at the $0.75/M endpoint |

- **Upper estimate at the cheapest endpoint:** about $0.03 per search ($0.025 + $0.0023 + $0.0073 ≈ $0.035), most of it Brave. If OpenRouter routes to the $0.75/M endpoint, the prompt alone adds up to about $0.061, so about $0.09 before any higher completion price at that endpoint.
