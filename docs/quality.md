...
- **Many local rows could not be judged.** 45 of 185 local rows had an unknown answer (a store page that lists no products, a dead site with a live map listing) and are left out of precision. The published figure likely understates local precision: in the regrade sample the second agent judged 7 of the 8 rows the first had left unknown as good, and on those 36 rows precision was 54% (15 of 28) by the first grades and 71% (24 of 34) by the second.
