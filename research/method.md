...
| OC37 | Decide whether Proposition 65 settlements naming only Patagonia Provisions (2022, 2023, 2025) count against Patagonia. Provisions sits beside Patagonia, Inc. under the same parent, Patagonia Works (all three were defendants in the counted 2021 settlement), so it's a sibling company, not a parent | [raw/prop65-P1.md](raw/prop65-P1.md) | If they count: Patagonia goes from `recommended` to `acceptable` (concerns within 5 years) |
