...
| Parent company actions (pass 3) | N4 agent, not yet reviewed | A parent's action counts against a retailer only when it concerns the retailer's own business | Naver's Korean fines (Poshmark) and Shopify's Canada Revenue Agency records dispute (Shop) are notes. Open as OC32 |
...
| OC32 | Decide whether a parent company's actions count against a retailer. Pass 3 counted them only when they concern the retailer's own business (N4), and N2 didn't carry eBay's concerns to Depop. No Rakuten Group search ran for Kobo | [raw/news-N2.md](raw/news-N2.md); [raw/news-N4.md](raw/news-N4.md); [raw/news-N3.md](raw/news-N3.md) | If they count: Depop goes from `acceptable` to `caution` (eBay's 2024 concern); others unknown until parent searches run |
| OC33 | Decide whether oag.ca.gov Proposition 65 notices join the accepted sources, and whether private-enforcer settlements with a court judgment count (Equal Exchange 2016, Patagonia Provisions 2022, Uncommon Goods 2006 with judgment, Grove 2025, Bob's Red Mill consent judgment) | [raw/news-N1.md](raw/news-N1.md); [raw/news-N2.md](raw/news-N2.md) | If all count: Equal Exchange, Patagonia, Uncommon Goods and Grove go from `recommended` to `acceptable`; Bob's Red Mill goes from `acceptable` to `caution` |
| OC34 | Decide whether fda.gov joins the accepted sources | [raw/news-N4.md](raw/news-N4.md) | Public Goods goes from `acceptable` to `caution` (2022 FDA warning letter) |
| OC35 | Decide whether a voluntary CPSC recall that states a regulatory violation, with no penalty, is a finding | [raw/news-N2.md](raw/news-N2.md) | No tier change (Avocado's ethics is already 0) |
| OC36 | Open the B Lab directory page for World of Books Group (https://www.bcorporation.net/en-us/find-a-b-corp/company/world-of-books-group/, 403 to agents) | [raw/news-N4.md](raw/news-N4.md) | Adds to OC5: World of Books goes from `acceptable` to `recommended` if certified |
