...
- **OSHA citations** (lead decision, 2026-09-25, matching what most batches did). A citation counts as a concern only if it carries a penalty and the case is not still open. A $0 citation or an open case is noted in the body. One inspection is one concern.
