...
| Retailer | Sites | Tier |
|---|---|---|
| [Etsy](retailers/etsy-com.md) | 13 | caution |
...
| [Grove Collaborative](retailers/grove-co.md) | 6 | acceptable |
| [EarthHero](retailers/earthhero-com.md) | 5 | acceptable |
| [Newegg](retailers/newegg-com.md) | 5 | caution |
| [Uncommon Goods](retailers/uncommongoods-com.md) | 5 | acceptable |
...
21 have nothing counted either way. Four have both certifications and concerns:
...
- [Equal Exchange](retailers/equalexchange-coop.md): worker co-op, minus a Proposition 65 settlement over cadmium in baking cocoa (2016). Was `recommended`.
- [Grove Collaborative](retailers/grove-co.md): B Corp (from `data/certifications.json`), minus a Proposition 65 settlement over lead in a greens supplement (2026). Was `recommended`.
- [Uncommon Goods](retailers/uncommongoods-com.md): B Corp (from `data/certifications.json`), minus a Proposition 65 settlement and court judgment over lead in glassware (2006). Was `recommended`.
...
- **Pass 1's OSHA and NLRB searches used pages that robots.txt disallows** (`osha.gov/ords/`, `nlrb.gov/search/`). This broke the run's own access rule, and every OSHA concern came from those pages. The operator decided on 2026-09-25 to keep them. All 18 were then confirmed through DOL's open-data API, which robots.txt allows: each matches on establishment, citation date, close date and penalty ([raw/osha-dol-match.md](raw/osha-dol-match.md)). The links still point to osha.gov, because the API needs a key.
...
- **B Corp could only count through `data/certifications.json`.** bcorporation.net blocked agents (HTTP 403) throughout ([raw/blocked-assess-F.md](raw/blocked-assess-F.md)). Four retailers get B Corp credit from rows in that file: Eileen Fisher, Grove Collaborative, Patagonia and Uncommon Goods (`verified_this_run: false`). World of Books counts because the operator opened its B Lab page. Other B Corp claims were noted and not counted, including those of Back Market, Better World Books, EarthHero, Kotn, Libro.fm, Love Grown and Thrive Market. If any of them were confirmed, its tier could rise.
