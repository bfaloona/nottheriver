# Blocked pages, retailer batch R3 (2026-09-25)

- https://violationtracker.goodjobsfirst.org/?company=aliexpress (HTTP 403): wanted Violation Tracker penalty records for AliExpress / Alibaba.
- https://ec.europa.eu/commission/presscorner/detail/en/ip_26_1654 (page body did not load, header only): wanted the EC press release on the AliExpress DSA fine; used the digital-strategy.ec.europa.eu copy instead.
- https://www.bcorporation.net/en-us/find-a-b-corp/company/back-market/ (HTTP 403): wanted to verify Back Market's B Corp certification (claimed on its about page and by three list sites).
