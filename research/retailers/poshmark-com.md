...
Operator-rule pass (2026-09-25): searched the California AG's Proposition 65 60-day notice database (Alleged Violator field) for `Poshmark`, `Naver`: the retailer and its parent, Naver Corporation. One notice names Poshmark, Inc. (2026-02516, Mercury Policy Project, mercury in skin creams) with a complaint filed but no settlement or judgment, so it is a note, not a concern; "Naver" returned no notices. No concern added.
...
- https://oag.ca.gov/prop65/60-day-notice-search-results?field_prop65_defendant_value=Poshmark&items_per_page=100 (no matching settlement)
- https://oag.ca.gov/prop65/60-day-notice-search-results?field_prop65_defendant_value=Naver&items_per_page=100 (no matching settlement)
