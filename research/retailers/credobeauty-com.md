---
name: Credo Beauty
domain: credobeauty.com
type: retailer
goods: [skincare, makeup, haircare, bath and body, fragrance]
ownership: unknown
parent: unknown
hq: unknown
marketplace: unknown
...
tier: acceptable
mentions: 6
mentioned_by: [amazonalts-org, goingzerowaste-com, goodgoodgood-co, sustainablejungle-com, thegoodtrade-com, vstyleblog-com]
checked: 2026-09-25
---

Credo Beauty is a "clean beauty" retailer selling skincare, makeup, haircare, bath and body products and fragrance from third-party brands and its own house brands (Credo Skincare, Follain, Cosmetics 27), online and in stores. Every product it sells must meet its own "Credo Standard" on ingredients, packaging, labor and environment; its site says it co-founded the Pact packaging-recycling program and has tracked emissions with a decarbonization plan since 2023. Wikipedia says it was founded in 2014 by former Sephora executives Annie Jackson and Shashi Batra, opened its first store in San Francisco in 2015, and acquired the Boston retailer Follain in 2022; neither source states its ownership or headquarters. Lists recommend it for clean, cruelty-free beauty.

No certification was found: Credo's own standard is self-set, not a certifier listing. The Climate Label directory has no Credo profile ("Brand Not Found") and it is not in the directory's brand list. NLRB case search for "Credo" returned no cases. OSHA's establishment search for "Credo" (2016 to 2026) returned only Credo Construction Inc and Credo Site 1 LLC, which are unrelated companies. No general news search was possible (the session's web search budget was used up).
...
- https://en.wikipedia.org/wiki/Credo_Beauty
- https://explore.changeclimate.org/brand/credo-beauty ("Brand Not Found")
- https://explore.changeclimate.org/ (certified brand directory)
- https://www.nlrb.gov/search/case/Credo
- https://www.osha.gov/ords/imis/establishment.search?p_logger=1&establishment=Credo&State=all&officetype=all&Office=all&startmonth=01&startday=01&startyear=2016&endmonth=09&endday=25&endyear=2026&p_case=all&p_violations_exist=all
