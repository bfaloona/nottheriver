...
Concern checks: an NLRB case search for "made trade" returned no results. CourtListener shows one docket, Fernandez v. Made Trade Group, LLC (S.D.N.Y., filed 2024-12-31), a disability-access suit; it is an allegation that does not fit the labor, governance or environmental kinds and is not recorded as a concern.
...
- Certifications: none verified (B Corp page blocked, 1% for the Planet and Climate Label directories not readable, not on Fair Trade USA's shop page).
