...
Company entity: the OSHA records below are for "Azure Farms Inc" at 500 Azure Ln, Moro, OR (NAICS 493190, warehousing). The tie to Azure Standard comes from a federal patent suit, Landmark Technology, LLC v. Azure Farms, Inc. (D. Or., filed 2018-08-24), whose complaint exhibit is titled "Sample Infringement of U.S. Patent No. 6,289,319 by Azure Standard". That suit is a patent claim with no finding and is not a concern.
