...
- OSHA inspection 1763330.015 (Overland Park, KS): one "Other" citation issued 2024-12-06, current penalty $9,403, resolved by formal settlement.
- OSHA inspection 1640222.015 (Chula Vista, CA, store #781): six citations issued 2023-03-15; three deleted (including the one "Serious" item) and three "Other" citations remain, current penalty $1,330.
- OSHA inspection 1356334.015 (Tracy, CA): five citations issued 2019-03-05; three deleted (including the "Serious" item) and two "Other" citations remain, current penalty $560.
