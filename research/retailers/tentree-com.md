...
- environment: 0.5 + 0.25 (The Climate Label, verified on explore.changeclimate.org) = 0.75. 1% for the Planet not checked: the directory returns no data to a plain fetch.
