...
Concerns:
- Brandon Briskin v. Shopify, Inc. (Ninth Circuit en banc opinion, filed 2025-04-21). Per the court's summary, Briskin "filed his putative class action alleging privacy-related torts" against Shopify, Inc. and two US subsidiaries, and his complaint "alleged that Shopify used the data gathered by its cookies to compile consumer profiles and then sold them without the consumer's knowledge or consent" after he paid on a merchant's Shopify checkout. The court held only that Shopify is subject to personal jurisdiction in California; it made no finding on the merits. Recorded as governance (consumer privacy); the source is an allegation. The concern attaches to Shopify, Shop's operator, not to Shop as a storefront.
