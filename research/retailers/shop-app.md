...
Operator-rule pass (2026-09-25): searched the California AG's Proposition 65 60-day notice database (Alleged Violator field) for `Shopify`: the parent, Shopify. One notice names Shopify Inc. among three alleged violators (2024-01983, a charcoal face mask) with no settlement or judgment recorded, so no concern added.
...
- https://oag.ca.gov/prop65/60-day-notice-search-results?field_prop65_defendant_value=Shopify&items_per_page=100 (no matching settlement)
